...
import fileHandling.Binary_Reader;
...
public class Analyzer_HistogramNew
{
	...
	private class Histogram {
		...
		public JsonNode toJson() {
			...
			obj.set("graph", jsonHistogramFile);
	...
	private JsonNode prepareReturnResults() {
		...
		landscape.set("file1", mLandscape_File1.toJson());
		landscape.set("file2", mLandscape_File2.toJson());
		landscape.set("range", mLandscapeMinMax.toJson());
		obj.set("landscape", landscape);
		
		sel.set("file1", mSelection_File1.toJson());
		sel.set("file2", mSelection_File2.toJson());
		sel.set("range", mSelectionMinMax.toJson());
		obj.set("selection", sel);
