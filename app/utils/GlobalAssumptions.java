...
public class GlobalAssumptions
{
	...
	public static void initAssumptions() 
	{
		...
		createAssumption(category,	"soc_m_perennials",		"Manure - Perennial Crops",		1.01f,	multiplierOptions);
		...
		createAssumption(category,	"n_m_perennials",	"Manure - Perennial Crops",		1.02f,	multiplierOptions);
		createAssumption(category,	"n_fm_perennials",	"Fall Manure - Perennial Crops",1.04f,	multiplierOptions);
	...
	private static ObjectNode createAssumptionCategory(String categoryName, String icon, boolean open)
	{
		...
		mHierarchicalAssumptions.set(categoryName, node);
